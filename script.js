...
function importHTML() {
    ...
    try {
        ...
        if (savedMain) {
            canvas.style.backgroundColor = savedMain.style.backgroundColor;
            document.getElementById('bgColorPicker').value = savedMain.style.backgroundColor;
            canvas.innerHTML = savedMain.innerHTML;
